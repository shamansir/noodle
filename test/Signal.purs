...
import Test.Spec.Runner (RunnerEffects, run, run')

expectFn :: forall e a. Eq a => Show a => Signal a -> Array a -> Eff (ref :: REF | e) Unit
...
expect :: forall e a. Eq a => Show a => Int -> Signal a -> Array a -> Eff (ref :: REF, timer :: TIMER, avar :: AVAR | e)
expect time sig vals = run' { timeout : time } $ expectFn sig vals
