...
import Hydra.Repr.Wrap (WrapRepr, hydraGenOptions_)
      ...
      it "properly generates Hydra Toolkit" $ do
        ...
        case eParsedNdf of
          ...
          Right parsedNdf -> do
            ...
            traverse_ ( testNodeDefCodegen "Hydra" $ hydraGenOptions_ $ customGenOptions "Hydra") definitions


customGenOptions tkName =
  { toModuleName : moduleName tkName
  , toInfoComment : \fgroup family -> "Generated by Noodle Codegen from " <> tkName <> " NDF file."
  }
