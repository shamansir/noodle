module Test.Files.CodeGenTest.Hydra.Synth.Mouse where
...
{- Generated by Noodle Codegen from Hydra NDF file. Group :: synth. Family :: mouse.

[[  synth : mouse :: <> => <x:Value {MX V} -> y:Value {MY V}> ]]
