module FOOBAR.Test.Files.CodeGenTest.Input.Hydra.Audio.Show where
...
[[  audio : show :: <audio:Audio {SIL} -> todo:TODO {TODO}> => <> ]] (#92) -}
...
family :: Family
family = Family.make _show defaultSt (Noodle.Shape :: Shape) defaultI defaultO showP
