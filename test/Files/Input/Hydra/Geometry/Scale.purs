...
[[ : geometry : scale :: <what:Texture {EMP T} -> amount:Value {N 1.5} -> xMult:Value {N 1.0} -> yMult:Value {N 1.0} -> offsetX:Value {N 0.5} -> offsetY:Value {N 0.5}> => out:Texture {EMP T} /-| out::HT.Geometry <what> $ HT.GScale { <amount>, <xMult>, <yMult>, <offsetX>, <offsetY> } |-/ ]]
