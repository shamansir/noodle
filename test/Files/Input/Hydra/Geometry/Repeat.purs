...
[[ : geometry : repeat :: <what:Texture {EMP T} -> repeatX:Value {N 3.0} -> repeatY:Value {N 3.0} -> offsetX:Value {N 0.0} -> offsetY:Value {N 0.0}> => out:Texture {EMP T} /-| out::HT.Geometry <what> $ HT.GRepeat { <repeatX>, <repeatY>, <offsetX>, <offsetY> } |-/ ]]
