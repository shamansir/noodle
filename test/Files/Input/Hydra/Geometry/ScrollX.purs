...
[[ : geometry : scrollX :: <what:Texture {EMP T} -> scrollX:Value {N 0.5} -> speed:Value {N 1.0}> => out:Texture {EMP T} /-| out::HT.Geometry <what> $ HT.GScrollX { <scrollX>, <speed> } |-/ ]] (#29) -}
...
scrollXP = do
  ...
  Fn.send _out_out $ HT.Geometry what $ HT.GScrollX { scrollX, speed }
