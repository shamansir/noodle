...
[[ : geometry : scroll :: <what:Texture {EMP T} -> scrollX:Value {N 0.5} -> scrollY:Value {N 0.5} -> speedX:Value -> speedY:Value> => out:Texture {EMP T} /-| out::HT.Geometry <what> $ HT.GScroll { <scrollX>, <scrollY>, <speedX>, <speedY> } |-/ ]] (#28) -}
