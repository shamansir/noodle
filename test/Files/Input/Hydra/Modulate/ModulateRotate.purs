...
[[ : modulate : modulateRotate :: <what:Texture {EMP T} -> with:Texture {EMP T} -> multiple:Value {N 1.0} -> offset:Value> => out:Texture {EMP T} /-| out::HT.ModulateWith { <what>, <with> } $ HT.ModRotate { <multiple>, <offset> } |-/ ]]
