module Test.Files.CodeGenTest.Hydra.Modulate.ModulatePixelate where
...
family :: Family
family = Family.make _modulatePixelate (HW.Value HT.None) (Noodle.Shape :: Shape) defaultI defaultO
  modulatePixelateP
