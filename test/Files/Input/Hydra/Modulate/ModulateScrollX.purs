...
[[ : modulate : modulateScrollX :: <what:Texture {EMP T} -> with:Texture {EMP T} -> scrollX:Value {N 0.5} -> speed:Value> => out:Texture {EMP T} /-| out::HYDRA.ModulateWith { <what>, <with> } $ HYDRA.ModScrollX { <scrollX>, <speed> } |-/ ]] (#58) -}

_modulateScrollX :: NId.Family "modulateScrollX"
_modulateScrollX = NId.Family

type Inlets =
  ( I "what" Hot HYDRA.Texture :> I "with" Hot HYDRA.Texture :> I "scrollX" Hot HYDRA.Value
...
defaultI = { what: HYDRA.Empty, with: HYDRA.Empty, scrollX: HYDRA.Number 0.5, speed: HYDRA.None }
...
modulateScrollXP = do
  ...
  Fn.send _out_out $ HYDRA.ModulateWith { what, with } $ HYDRA.ModScrollX { scrollX, speed }
