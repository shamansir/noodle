module Test.Files.CodeGenTest.Hydra.Color.A where
...
type Node = Noodle.Node "a" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
type Family = Noodle.Family "a" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
type F = Noodle.F "a" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
...
family :: Family
family = Family.make _a (HW.Value HT.None) (Noodle.Shape :: Shape) defaultI defaultO aP
