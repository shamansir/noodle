module Test.Files.CodeGenTest.Input.Hydra.Color.B where
...
[[ : color : b :: <what:Texture {EMP T} -> scale:Value {N 1.0} -> offset:Value {N 0.0}> => out:Texture {EMP T} /-| out::HT.Filter <what> $ HT.B { <scale>, <offset> } |-/ ]] (#45) -}
