module FOOBAR.Test.Files.CodeGenTest.Input.Hydra.Color.Color where
...
[[ : color : color :: <what:Texture {EMP T} -> r:Value {N 1.0} -> g:Value {N 1.0} -> b:Value {N 1.0} -> a:Value {N 1.0}> => out:Texture {EMP T} /-| out::HYDRA.Filter <what> $ HYDRA.Color { <r>, <g>, <b>, <a> } |-/ ]] (#38) -}
...
type Node = Noodle.Node "color" State InletsRow OutletsRow WrapRepr Effect
type Family = Noodle.Family "color" State InletsRow OutletsRow WrapRepr Effect
type F = Noodle.F "color" State InletsRow OutletsRow WrapRepr Effect

defaultI :: Record InletsRow
defaultI =
  { what: HYDRA.Empty, r: HYDRA.Number 1.0, g: HYDRA.Number 1.0, b: HYDRA.Number 1.0, a: HYDRA.Number 1.0 }
...
colorP = do
  ...
  b <- Fn.receive _in_b
  a <- Fn.receive _in_a
  Fn.send _out_out $ HYDRA.Filter what $ HYDRA.Color { r, g, b, a }
