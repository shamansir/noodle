module Test.Files.CodeGenTest.Input.Hydra.Blend.Blend where
...
[[ : blend : blend :: <what:Texture {EMP T} -> with:Texture {EMP T} -> amount:Value {N 0.5}> => out:Texture {EMP T} /-| out::HT.BlendOf { <what>, <with> } $ HT.Blend <amount> |-/ ]] (#50) -}
