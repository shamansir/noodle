module Test.Files.CodeGenTest.Input.Hydra.Blend.Add where
...
[[ : blend : add :: <what:Texture {EMP T} -> with:Texture {EMP T} -> amount:Value {N 1.0}> => out:Texture {EMP T} /-| out::HT.BlendOf { <what>, <with> } $ HT.Add <amount> |-/ ]] (#47) -}
