...
{- Generated by Noodle Codegen from Hydra NDF file. Group :: blend. Family :: add.

[[ : blend : add :: <what:Texture {EMP T} -> with:Texture {EMP T} -> amount:Value {N 1.0}> => out:Texture {EMP T} /-| out::HYDRA.BlendOf { <what>, <with> } $ HYDRA.Add <amount> |-/ ]] (#47) -}
...
type Node = Noodle.Node "add" State InletsRow OutletsRow WrapRepr Effect
type Family = Noodle.Family "add" State InletsRow OutletsRow WrapRepr Effect
type F = Noodle.F "add" State InletsRow OutletsRow WrapRepr Effect
...
family :: Family
family = Family.make _add defaultSt (Noodle.Shape :: Shape) defaultI defaultO addP
...
addP = do
  ...
  Fn.send _out_out $ HYDRA.BlendOf { what, with } $ HYDRA.Add amount
