...
type Inlets = (I "options" Hot HYDRA.SourceOptions :> TNil) :: Noodle.Inlets
type Outlets = TNil :: Noodle.Outlets
type InletsRow = (options :: HYDRA.SourceOptions)
type OutletsRow = ()
...
defaultI = { options: HYDRA.SourceOptions { src: HYDRA.Canvas } }
