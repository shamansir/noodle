...
list :: forall id r. IsSymbol id => NodeKey Subject.List id -> C.Node Subject.List id ( OptionsRow + r ) Event
list nodeKey = C.node nodeKey


listAnd :: forall id r. IsSymbol id => NodeKey Subject.List id -> C.NodeAnd Subject.List id ( OptionsRow + r ) Event
