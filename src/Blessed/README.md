...
To tag your text so that it is coloured you may use `Data.Text.Format`, [here's an example](https://github.com/shamansir/noodle/blob/main/src/Cli/Tagging.purs).
