module StarterTk.Simple.Random where
...
type Node = Noodle.Node "random" StarterRepr InletsRow OutletsRow StarterRepr Effect
type Family = Noodle.Family "random" StarterRepr InletsRow OutletsRow StarterRepr Effect
type F = Noodle.F "random" StarterRepr InletsRow OutletsRow StarterRepr Effect
