...
type Node = Noodle.Node "sum" ProcessingRepr InletsRow OutletsRow ProcessingRepr Effect
type Family = Noodle.Family "sum" ProcessingRepr InletsRow OutletsRow ProcessingRepr Effect
type F = Noodle.F "sum" ProcessingRepr InletsRow OutletsRow ProcessingRepr Effect
