...
type Node = Noodle.Node "log" ProcessingRepr InletsRow OutletsRow ProcessingRepr Effect
type Family = Noodle.Family "log" ProcessingRepr InletsRow OutletsRow ProcessingRepr Effect
type F = Noodle.F "log" ProcessingRepr InletsRow OutletsRow ProcessingRepr Effect
