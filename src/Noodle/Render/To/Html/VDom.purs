module Noodle.Render.Html.VDom
    (embed, embed') where
...
import Noodle.API.Action (Action(..), DataAction(Bang), RequestAction(ToAddPatch)) as A
import Noodle.Toolkit (Toolkit) as T
import Noodle.Render.Renderer (Renderer, Routed(..)) as UI
