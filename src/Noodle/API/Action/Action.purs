module Noodle.API.Action where
...
import Noodle.Process (ProcessF, InletAlias, OutletAlias)
import Noodle.Util (Canceler)
import Noodle.Toolkit (NodeDef)
...
{-
data NoodleEffect d c n -- TODO: move to a separate module
    = DoE (Perform d c n)
