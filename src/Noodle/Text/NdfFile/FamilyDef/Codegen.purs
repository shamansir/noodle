...
__raw_process_pattern familyR = "do\n" <> __raw_process_indent <> "{- " <> __raw_process_stub familyR <> " -}\n" <> __raw_process_indent <> "pure unit" :: String
__raw_process_expr :: Partial => OverLeadingComments Void => Id.FamilyR -> CST.Expr Void
__raw_process_expr familyR = exprDo [ ] (leading (lineBreaks 1 <> blockComment (__raw_process_stub familyR) <> lineBreaks 1) $ exprApp (exprIdent "pure") [ exprIdent "unit" ])
