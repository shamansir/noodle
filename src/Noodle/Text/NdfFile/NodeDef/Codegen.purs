...
import Data.String (Pattern(..), Replacement(..), replace, toUpper, take, drop) as String
...
newtype Options repr = Options
    ...
    , infoComment :: Maybe (FamilyGroup -> NodeFamily -> String)
    , prepr :: Proxy repr
...
generateModule (Options opts) (FamilyGroup fGroup) (StateDef state) fn
  ...
  let
    ...
    infoComment :: String
    infoComment = maybe __default_info_comment (\f -> f (FamilyGroup fGroup) $ NodeFamily $ Fn.name fn) opts.infoComment
