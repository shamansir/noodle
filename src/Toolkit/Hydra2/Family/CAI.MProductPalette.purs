module Toolkit.Hydra2.Family.CAI.FPalette where
...
family = -- {-> caiProductPalette <-}
    Family.def
        ...
        $ Fn.make name
            ...
            P.send _out_primary $ H.Filter texture $ H.Color { r : H.Number 1.0, g : H.Number 1.0, b : H.Number 1.0, a : H.Number 1.0}
            P.send _out_secondary $ H.Filter texture $ H.Color { r : H.Number 1.0, g : H.Number 1.0, b : H.Number 1.0, a : H.Number 1.0}
            P.send _out_ternary $ H.Filter texture $ H.Color { r : H.Number 1.0, g : H.Number 1.0, b : H.Number 1.0, a : H.Number 1.0}
