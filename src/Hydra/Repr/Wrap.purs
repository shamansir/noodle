...
hydraGenOptions = CG.Options
    ...
    , infoComment : Just $ \mbSource (FamilyGroup fgroup) (NodeFamily family) ->
            "Generated by Noodle Codegen from Hydra NDF file. Group :: " <> fgroup <> ". Family :: " <> family <> "." <> case mbSource of
            Just src -> "\n\n[[ " <> src <> " ]]"
            Nothing -> ""
