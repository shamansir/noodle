...
type Node = Noodle.Node "shift" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
type Family = Noodle.Family "shift" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
type F = Noodle.F "shift" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
...
family :: Family
family = Family.make _shift (HW.Value HT.None) (Noodle.Shape :: Shape) defaultI defaultO shiftP
