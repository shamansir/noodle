module Test.Files.CodeGenTest.Input.Hydra.Color.R where
...
type Node = Noodle.Node "r" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
type Family = Noodle.Family "r" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
type F = Noodle.F "r" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
...
family :: Family
family = Family.make _r (HW.Value HT.None) (Noodle.Shape :: Shape) defaultI defaultO rP
