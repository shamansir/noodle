module Test.Files.CodeGenTest.Input.Hydra.Modulate.ModulateRepeat where
...
[[ : modulate : modulateRepeat :: <what:Texture {EMP T} -> with:Texture {EMP T} -> repeatX:Value {N 3.0} -> repeatY:Value {N 3.0} -> offsetX:Value {N 0.5} -> offsetY:Value {N 0.5}> => out:Texture {EMP T} /-| out::HT.ModulateWith { <what>, <with> } $ HT.ModRepeat { <repeatX>, <repeatY>, <offsetX>, <offsetY> } |-/ ]] (#54) -}
