...
type Node = Noodle.Node "modulateRotate" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
type Family = Noodle.Family "modulateRotate" HW.WrapRepr InletsRow OutletsRow WrapRepr Effect
...
family :: Family
family = Family.make _modulateRotate (HW.Value HT.None) (Noodle.Shape :: Shape) defaultI defaultO
  modulateRotateP
