module Prev.Toolkit.Hydra.Fn.Gen
  ( Evaluate(..)
  , Fn, toNodeFn
  , fn2v
  )
...
import Prev.Noodle.Fn (make, in_, out_, mapM, mapInputsAndOutputs, mapInputsAndOutputsIds) as Fn
import Prev.Noodle.Fn.Process (receive, send, sendIn, lift) as Fn
import Prev.Noodle.Channel as Channel
import Prev.Noodle.Node as Node
import Prev.Noodle.Node (NodeFn)
